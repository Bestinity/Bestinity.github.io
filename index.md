...
-채공 알고리즘 발동조건과 그 설명-<br>
1. 격납고 탐색영역내의 타격가능한 적을 향해 이동함.<br>
2. 전투기 기준 일정 범위 안에 적이 있고, 공격 가능한 태그를 달고 있으면 공격<br>
3. 공격대기상태일때, 채공 알고리즘 작동
	ㄴ 채공 알고리즘: 공격한 적의 위치를 기준으로 일정 범위 안을 무작위로 마구 돌아다님<br>
