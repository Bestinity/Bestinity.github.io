...
2) 보조 규칙  
동맹
동맹을 맺을 수는 있으나, 파기할 때는 병력을 상대방의 본진에 배치시킨 뒤 기습공격 하는 플레이를 막기 위해 별도의 규칙이 적용된다. 동맹을 파기하는 순간, 상대방의 도시나 자원매장지에서일정 거리 안에 있는 유닛들은 제일 가까운 자신의 도시 근처에 강제배치 된다. (해상유닛의 경우 제일 가까운 도시가 내륙일 때, 해안도시로 배치 되게 된다.)
