...
[9.스토리보드](#스토리보드)  
[10.개발작업 일정](#개발작업-일정)  
[11.개발작업 일정_season2](#개발작업-일정_season2)
# 컨셉
...
# 개발작업 일정_season2
## 1주차
noise효과를 이용해 지형생성 프로그램 만들기  
지형생성 프로그램을 맵에 적용시키기
## 2주차
noise효과를 이용해 나무 및 자원 배치하기
## 3주차
건물이 지형능선을 따라 건설되게 하기(단, 경사에따라 건설범위가 제약됨(1)
## 4주차
건물이 지형능선을 따라 건설되게 하기(단, 경사에따라 건설범위가 제약됨(2)
## 5주차
유닛을 생성해 맵상에다 이동시키기(단, 경사에따라 이동범위가 제약됨)(1)
## 6주차
유닛을 생성해 맵상에다 이동시키기(단, 경사에따라 이동범위가 제약됨)(2)
## 7주차
유닛 추가&조작&AI(1)
## 8주차
유닛 추가&조작&AI(2)
...
자원관리 시스템 및 ui추가
## 10주차
건물 추가 및 건설&생산시스템 구현(1)
## 11주차
건물 추가 및 건설&생산시스템 구현(2)
## 12주차
초기화면 작업 및 설정 인터페이스 작업 및 배경음악 작업

++ 던전추가 (적 건물이 있으며 일정량의 유닛을모으면 플레이어 기지로 공격함)
++ 국가추가 및 국가마다 특수유닛&건물&배경음악 추가
